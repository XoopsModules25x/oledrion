<div class="oledrion-block">
    <ul>
        <{foreach item=list from=$block.category_lists}>
            <li>
    ...
    <br>
    <div align="center">
        <a href="<{$smarty.const.OLEDRION_URL}>all-lists.php"
           href="<{$smarty.const._MB_OLEDRION_SEE_ALL_LISTS}>"><{$smarty.const._MB_OLEDRION_SEE_ALL_LISTS}></a>
    </div>
</div>
