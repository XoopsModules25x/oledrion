<div class="oledrion">
    ...
    <{if $order.cmd_track}>
        <div class="oledrion_otherinf">
            ...
            <p>برای مشاهده مکان بسته خود به وب سایت <a href="http://tntsearch.post.ir/">tntsearch.post.ir</a> مراجعه
                نمایید و با زدن کد رهگیری خود از مکان بسته با خبر شوید.</p>
        </div>
    <{/if}>
