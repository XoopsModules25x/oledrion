...
switch ($action) {
    case 'default':
        ...
        $form    = "<form method='post' action='$baseurl' name='frmaddpacking' id='frmaddpacking'><input type='hidden' name='op' id='op' value='packing'><input type='hidden' name='action' id='action' value='add'><input type='submit' name='btngo' id='btngo' value='"
                   ...
                   . "'></form>";
        echo $form;
        //        \Xoopsmodules\oledrion\Utility::htitle(_MI_OLEDRION_ADMENU18, 4);
    ...
    case 'edit':
        ...
        $editor = \Xoopsmodules\oledrion\Utility::getWysiwygForm(_AM_OLEDRION_DESCRIPTION, 'packing_description', $item->getVar('packing_description', 'e'), 15, 60, 'description_hidden');
        if ($editor) {
