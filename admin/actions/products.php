...
switch ($action) {
    ...
    case 'default': // Gestion des produits
        ...
        \Xoopsmodules\oledrion\Utility::htitle(_MI_OLEDRION_ADMENU4 . ' (' . $itemsCount . ')', 4);
        ...
        $onlineSelect      = \Xoopsmodules\oledrion\Utility::htmlSelect('filter_product_online', [2 => _YES, 1 => _NO], $filter_product_online);
        $recommendedSelect = \Xoopsmodules\oledrion\Utility::htmlSelect('filter_product_recommended', [1 => _YES, 2 => _NO], $filter_product_recommended);
    ...
    case 'unrecommend': // Arrêter de recommander un produit
        ...
        if (isset($_GET['product_id'])) {
            ...
            \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_ERROR_1, $baseurl . $opRedirect, 4);
        }
        break;
    ...
    case 'edit': // Edition d'un produit
        ...
        if (0 == count($categories)) {
            \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_ERROR_8, $baseurl, 5);
        }
        // TVA
        $vats = $vatsForDisplay = [];
        $vats = $h_oledrion_vat->getAllVats(new Oledrion_parameters());
        if (0 == count($vats) && \Xoopsmodules\oledrion\Utility::getModuleOption('use_price')) {
            \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_ERROR_9, $baseurl, 5);
        }
        ...
        $sform->addElement(new XoopsFormFile(_AM_OLEDRION_IMAGE1_CHANGE, 'attachedfile1', \Xoopsmodules\oledrion\Utility::getModuleOption('maxuploadsize')), false);

        if (!\Xoopsmodules\oledrion\Utility::getModuleOption('create_thumbs')) { // L'utilisateur se charge de créer la vignette lui même
            ...
            $sform->addElement(new XoopsFormFile(_AM_OLEDRION_IMAGE2_CHANGE, 'attachedfile2', \Xoopsmodules\oledrion\Utility::getModuleOption('maxuploadsize')), false);
        }
        ...
        $editor2 = \Xoopsmodules\oledrion\Utility::getWysiwygForm(_OLEDRION_SUMMARY, 'product_summary', $item->getVar('product_summary', 'e'), 15, 60, 'summary_hidden');
        if ($editor2) {
            $sform->addElement($editor2, false);
        }

        $editor = \Xoopsmodules\oledrion\Utility::getWysiwygForm(_OLEDRION_DESCRIPTION, 'product_description', $item->getVar('product_description', 'e'), 15, 60, 'description_hidden');
        if ($editor) {
        ...
        $downloadFile = new XoopsFormFile(_OLEDRION_ATTACHED_FILE, 'attachedfile3', \Xoopsmodules\oledrion\Utility::getModuleOption('maxuploadsize'));
        $downloadFile->setDescription(_AM_OLEDRION_ATTACHED_HLP);
        $sform->addElement($downloadFile, false);

        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property1')) {
            $property1select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property1_title'), 'product_property1', $item->getVar('product_property1'));
            $property1Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property1'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property2')) {
            $property2select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property2_title'), 'product_property2', $item->getVar('product_property2'));
            $property2Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property2'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property3')) {
            $property3select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property3_title'), 'product_property3', $item->getVar('product_property3'));
            $property3Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property3'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property4')) {
            $property4select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property4_title'), 'product_property4', $item->getVar('product_property4'));
            $property4Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property4'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property5')) {
            $property5select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property5_title'), 'product_property5', $item->getVar('product_property5'));
            $property5Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property5'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property6')) {
            $property6select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property6_title'), 'product_property6', $item->getVar('product_property6'));
            $property6Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property6'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property7')) {
            $property7select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property7_title'), 'product_property7', $item->getVar('product_property7'));
            $property7Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property7'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property8')) {
            $property8select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property8_title'), 'product_property8', $item->getVar('product_property8'));
            $property8Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property8'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property9')) {
            $property9select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property9_title'), 'product_property9', $item->getVar('product_property9'));
            $property9Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property9'));
        ...
        if (\Xoopsmodules\oledrion\Utility::getModuleOption('product_property10')) {
            $property10select = new XoopsFormSelect(\Xoopsmodules\oledrion\Utility::getModuleOption('product_property10_title'), 'product_property10', $item->getVar('product_property10'));
            $property10Array  = explode('|', \Xoopsmodules\oledrion\Utility::getModuleOption('product_property10'));
    ...
    case 'saveedit': // Sauvegarde des informations d'un produit
        ...
        if (true === $res1) {
            ...
            if (\Xoopsmodules\oledrion\Utility::getModuleOption('resize_main')) { // On redimensionne l'image principale
        ...
        if (!\Xoopsmodules\oledrion\Utility::getModuleOption('create_thumbs')) { // L'utilisateur se charge de créer la vignette lui-même
            $destname = '';
            $res2     = \Xoopsmodules\oledrion\Utility::uploadFile(1, OLEDRION_PICTURES_PATH);
            if (true === $res2) {
            ...
            if ('' !== xoops_trim($mainPicture)) {
                ...
                \Xoopsmodules\oledrion\Utility::resizePicture(OLEDRION_PICTURES_PATH . '/' . $mainPicture, OLEDRION_PICTURES_PATH . '/' . $thumbName, \Xoopsmodules\oledrion\Utility::getModuleOption('thumbs_width'), \Xoopsmodules\oledrion\Utility::getModuleOption('thumbs_height'), true);
        ...
        $destname = '';
        $res3     = \Xoopsmodules\oledrion\Utility::uploadFile($indiceAttached, OLEDRION_ATTACHED_FILES_PATH);
        if (true === $res3) {
    ...
    case 'copy': // Copier un produit
        ...
        if (is_object($product)) {
            ...
            if (false !== $newProduct) {
                \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_SAVE_OK, $baseurl . '?op=' . $opRedirect . '&action=edit&id=' . $newProductId, 2);
            } else {
                \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_SAVE_PB, $baseurl . '?op=' . $opRedirect, 5);
            }
        }
    ...
    case 'delete': // Suppression d'un produit
        ...
        if (0 == count($tblTmp)) {
            ...
            \Xoopsmodules\oledrion\Utility::htitle(_AM_OLEDRION_SORRY_NOREMOVE, 4);
            $tblTmp2 = [];
...
//        $criteria = new Criteria(/*'product_id', $item->getVar('product_id'), '<>'*/);
    ...
    case 'relatedsave':
        ...
        $opRedirect = 'products';
        \Xoopsmodules\oledrion\Utility::redirect(_AM_OLEDRION_SAVE_OK, $baseurl . '?op=' . $opRedirect, 5);
        break;
}
