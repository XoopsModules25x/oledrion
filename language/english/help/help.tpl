<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_OLEDRION_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>

    <p class="even">This module is an e-Commerce module for XOOPS.<br> <br>
    </p>
    ...
    <p class="even">Please view our on-line tutorial on <a
            href="https://www.gitbook.com/book/mambax7/xoops-oledrion-tutorial/" target="_blank">GitBook</a>.</p>
    <p class="even">To contribute to the Tutorial, <a href="https://github.com/XoopsDocs/oledrion-tutorial/"
                                                      target="_blank">fork it on GitHub!</a></p>
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/oledrion" target="_blank">GitHub</a><br><br>
